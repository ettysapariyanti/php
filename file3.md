...
<html>
    ...
    <body>
        ...
        <h2>ARNA - Laporan Keuangan</h2>

        <p>Laporan Keuangan PT Arwana CitraMulia TBK</p>
        ...
        <div class="container">
            ...
            <form action="/action_page.php">
                ...
                <div class="row">
                    ...
                    <div class="col-A">
                        <input type="button" class="buttonSimpan" value="Simpan Data">
                    </div>
                    <div class="col-B">
                        <input type="button" class="buttonEdit" value="Edit Data">
                    </div>
                    <div class="col-C">
                        <input type="button" class="buttonHapus" value="Hapus Data">
                    </div>
                </div>
